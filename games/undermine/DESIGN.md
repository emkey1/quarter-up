...
> **Status:** design v1, nothing implemented. This document is the plan; §11 is the
...
| | Scope | Accept |
| --- | --- | --- |
| **M0** | Skeleton. Workspace on `@quarter-up/cabinet`, canvas, a field of earth rendering with autotiling, a digger that carves it. | Dev server runs, digging works, tests pass. |
